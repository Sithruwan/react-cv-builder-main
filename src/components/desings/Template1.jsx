...
import  TemplateOne  from "../../assets/TemplateAssets/Template1.png";
import {
  FaHouse,
  FaTrash,
  FaPenToSquare,
...
const Template1 = () => {
  ...
  const generatePDF = async () => {
    ...
    htmlToImage.toPng(element).then((dataUrl) => {
      ...
      const verticalMarging = (a4Height - imgHeight) / 2;
      let pdf = new jsPDF({
        orientation: "portrait",
        unit: "mm",
        format: [a4Width, a4Height],
      });
      pdf.addImage(dataUrl, "PNG", 0, verticalMarging, imgWidth, imgHeight);
      pdf.save("resume.pdf");
    }).catch((error) => {
